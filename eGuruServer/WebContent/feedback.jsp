        ...
        <div id="content">
			...
			<br><br>
		 		<table class="table table-bordered table-hover" style="border:1px solid black;margin-left:100px;margin-right:auto;padding:2px;border-spacing:20px;align:center">
				    ...
				    <tbody>
				    	<tr>		
							<td bgcolor=FF7733>Enter your name:</td>		
							<td> <input type="text" name="fb_uname" ></input> </td>	
						</tr>
						
						<tr>		
							<td bgcolor=FF7733>Feedback regarding (Enter id):</td>		
							<td> <input type="text" name="fb_entity" size="46"></input> </td>	
						</tr>
						
				    
				    	<tr>
				    		<td bgcolor=FF7733>Enter feedback description<br> Or Uploaded Feedback Document URL:</td>	
				    		<td>
				    		<textarea name="userfeedback" rows="4" cols="49">	</textarea>
							</td>
				    	</tr>
