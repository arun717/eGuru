			...
			<br><br>
		 		<table class="table table-bordered table-hover" style="border:1px solid black;margin-left:100px;margin-right:auto;padding:2px;border-spacing:20px;align:center">
		        	...
		        	<thead class="thead-dark">
					    <tr>		
					      <th colspan="4">Enter New Team Details</th>
					    </tr>
					</thead>	
					    <tbody>
					    	<tr>		
								<td bgcolor=FF7733>Enter TeamID:</td>		
								<td> <input type="text" name="tb_teamid"></input> </td>	
							</tr>
							
							<tr>		
								<td bgcolor=FF7733>Enter Member ID:</td>		
								<td> <input type = "text" name="tb_memid"></input> </td>	
							</tr>
							
							<tr>		
								<td bgcolor=FF7733>Enter Member Name:</td>		
								<td> <input type="text" name="tb_memname"></input> </td>	
							</tr>
							
							<tr>		
								<td bgcolor=FF7733>Enter Image URL:</td>		
								<td> <input type="text" name="tb_url"></input> </td>	
							</tr>
