    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
				...
				<li>
					<a href="teacherEval.jsp">Evaluation</a>
				</li>
        ...
        <div id="content">
			...
			<H3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			Evaluate individual team members...</H3><br>
			...
			<table class="table table-bordered table-hover" style="border:1px solid black;margin-left:100px;margin-right:auto;padding:2px;border-spacing:20px;align:center">
			  <thead>
			    <tr>		
			     <td style="color:green">Member ID</td>			  	
			  	 <td style="color:green">Member Name</td>
			  	 <td style="color:green">Evaluation</td>
			    </tr>
			  </thead>
			  <tbody>
			  <%
					...
					String tidno =  request.getParameter("teamid");
					
					String sql ="SELECT * FROM `teammemberdetails` WHERE TeamID = " + tidno;
					resultSet = statement.executeQuery(sql);	
					String member_id="";
					String member_name="";
					while(resultSet.next())
					{
						member_id = resultSet.getString("MemberID");
						member_name = resultSet.getString("MemberName");
						
					
					
				%>
			  		<tr>		
						<td style="width: 50%;" bgcolor=lightyellow> <a href="evalMembers.jsp" style="color:#0000ff;"> <%= member_id%> </a> </td>
						<td style="width: 50%;" bgcolor=lightyellow>  <%= member_name%> </td>
