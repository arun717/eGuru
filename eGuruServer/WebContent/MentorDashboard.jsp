			...
			<table class="table table-bordered table-hover" style="border:1px solid black;margin-left:100px;margin-right:auto;padding:2px;border-spacing:20px;align:center">
			  ...
			  <%
				...
				%>
					...
					<tr>		
						<td style="width: 25%;" bgcolor=lightyellow> Team Id Number <%=j%></td>
						<td style="width: 25%;" bgcolor=lightyellow align="right">  
						<a href="allQuestions.jsp" style="color:blue;">View Question</a></td>
