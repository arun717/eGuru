...
<body>
    ...
    -->
		<div id="content">		
			...
			<br><br>
		 		<!-- <table class="table table-bordered table-hover" style="border:1px solid black;margin-right:auto;padding:2px;border-spacing:20px;align:center"> -->
		 		<table class="table table-bordered table-hover" style="border:1px solid black;padding:2px;margin-left:400px;">
		        	<thead class="thead-dark">
					    <tr>		
					      <th colspan="2">Enter Login credentials....</th>
					    </tr>
					</thead>	
					    <tbody>
					    	<tr>		
								...
								<td>   <select name="userType">
										    ...
										    <option value="Other">Mentor</option>									
									   </select> 
								</td>	
							</tr>
