...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
			...
			<H3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<b style="color:red;">Birla Institute Of Technology and Science, Pilani</b>	
			<br><br>
			&nbsp;&nbsp;&nbsp;Centre for Software Development,SDET Unit, BITS-Pilani, India.
			<br><br>
			&nbsp;&nbsp;&nbsp;eGuru@pilani.bits-pilani.ac.in
			<br><br>
			&nbsp;&nbsp;&nbsp;Location : Media Lab, Room Number : 3231, SDET, FD-III, Pilani Campus
