...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
			...
			<H3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			Select a team id to evaluate...</H3><br>
			...
			<table class="table table-bordered table-hover" style="border:1px solid black;margin-left:100px;margin-right:auto;padding:2px;border-spacing:20px;align:center">
			  <thead>
			    <tr>		
			     <td style="color:green">Team ID</td>			  	
			  	<td style="color:green">Team Name</td>
			    </tr>
			  </thead>
			  <tbody>
			  <%
					...
					{
						tid = resultSet.getString("TeamID");
				...
				%>
			  		<tr>		
						<td style="width: 50%;" bgcolor=lightyellow> <a href="evalMembers.jsp?teamid=<%=tid%>" style="color:#0000ff;"> <%= tid%> </a> </td>
						<td style="width: 50%;" bgcolor=lightyellow>  <%= tname%> </td>
					</tr>
